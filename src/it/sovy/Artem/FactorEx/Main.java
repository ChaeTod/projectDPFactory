...
public class Main {
    public static void main(String[] args) {
        Configuration cessna = PlaneFactory.getPlane("CA", "Crew - 1", "1.185 km", "1.7 kN");
        Configuration c17 = PlaneFactory.getPlane("CP", "Crew - 3", "4.480 km", "180 kN");
        Configuration F15E = PlaneFactory.getPlane("MFP", "Crew - 1", "1.965 km", "64.9 kN");
